"""RAG 쿼리: 사진/질문 → Vision 분석 → 교과서 검색 → 어린이 응답"""
...
def query(
    ...
    Returns:
        { "answer": str, "curiosity_hooks": list, "curriculum_refs": list }
    """
    image_urls = image_urls or []
